...
const Card = props => {
  const {id, value, updatedAt, category, isFavouriteList} = props;

  return (
    <Fragment>
      <div
        className={`main-card rounded-${
          isFavouriteList ? 'sm' : 'lg'
        } border-0 mb-3`}
      >
        ...
        <div className="card-body px-3 pt-2 pb-3">
          <div className="row">
            ...
            <div className="col">
              ...
              <p
                className={`card-text ${
                  isFavouriteList ? 'fz-14 lh-20' : 'fz-18'
                }`}
              >
                {value}
              </p>
              ...
              {category && (
                <button className="btn-sm category-btn card-category fz-10 lh-14">
                  {category}
                </button>
              )}
            </div>
