		...
		<>
			<header className="header">
				<div className="container">
					{/* <div className="row">
						<nav className="col navbar nav">
							<span className="nav__logo">MSI 2020</span>
							<div className="nav__right d-flex justify-content-between align-items-center">
								<div className="nav__btn">
									<div className="wrapper  d-flex justify-content-center">
										<span className="nav__line line-1"></span>
										<span className="nav__line line-2"></span>
									</div>
								</div>
								<span className="nav__text">Favourite</span>
							</div>
						</nav>
					</div> */}

					<nav class="navbar navbar-light nav">
						<a class="navbar-brand font-weight-bold lh-28">MSI 2020</a>
						<div className="nav-right d-flex">
							...
							<span className="nav-text ml-2 text-muted">Favourite</span>
						</div>
					</nav>
				</div>
			</header>
									...
									<div className="row">
										...
										<div className="col">
											...
											{/* <div className="card-category">
												<div className="card-category-text">Celebrity</div>
											</div> */}
										</div>
									</div>
								</div>
			...
			{/* <div className="container">
				<div className="row">
					<nav className="col navbar nav justify-content-end">
						<div className="nav__right d-flex justify-content-between align-items-center">
							<div className="nav__btn">
								<div className="wrapper  d-flex justify-content-center">
									<span className="nav__line line-1"></span>
			...
			{/* <section className="section">
				<div className="container">
					<div className="row">
						<div className="col">
							<div className="card favourite-card border-0 mb-3">
								<div className="card-header bg-transparent text-right border-0">
									<svg
										width="20"
										height="17"
										viewBox="0 0 20 17"
									...
									<div className="row">
										...
										<div className="col-11">
											<div className="card-title">
												ID: <a href="#">XNaAxUduSw6zANDaIEab7A</a>
											</div>
